...
Initial audit: **2026-08-21**. Re-run the audit before the renewal review and then at least twice per year. Repository metadata changes quickly; `catalogue.yml` records the current decision, not an eternal truth.
